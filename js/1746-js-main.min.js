...
e+="bold"==t.getFontWeight()?'<label class="btn btn-default active" style="background-image: url(images/bold.png); width: 40px; height: 40px; border-radius: 10px; margin: 20px; margin-bottom: 10px;" id="texttoolbox_bold"><input type="checkbox" autocomplete="off" istool="bold" checked></label>':'<label class="btn btn-default" style="background-image: url(images/bold.png); width: 40px; height: 40px; border-radius: 10px; margin: 20px; margin-bottom: 10px;" id="texttoolbox_bold"><input type="checkbox" autocomplete="off" istool="bold"></label>',e+="italic"==t.getFontStyle()?'<label class="btn btn-default active" style="background-image: url(images/italic.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_italic"><input type="checkbox" autocomplete="off" istool="italic" checked></label>':'<label class="btn btn-default" style="background-image: url(images/italic.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_italic"><input type="checkbox" autocomplete="off" istool="italic"></label>',e+=t.getTextDecoration().indexOf("underline")>=0?'<label class="btn btn-default active" style="background-image: url(images/underline.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_underline"><input type="checkbox" autocomplete="off" istool="underline" checked></label>':'<label class="btn btn-default" style="background-image: url(images/underline.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_underline"><input type="checkbox" autocomplete="off" istool="underline"></label>',e+=t.getTextDecoration().indexOf("line-through")>=0?'<label class="btn btn-default active" style="background-image: url(images/line-through.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_strikethrough"><input type="checkbox" autocomplete="off" istool="strikethrough" checked></label>':'<label class="btn btn-default" style="background-image: url(images/line-through.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 10px;" id="texttoolbox_strikethrough"><input type="checkbox" autocomplete="off" istool="strikethrough"></label>',e+=t.isEditing?'<label class="btn btn-default active" style="background-image: url(images/edit.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 20px;" id="texttoolbox_edit""><input type="checkbox" autocomplete="off" istool="edit" checked></label>':'<label class="btn btn-default" style="background-image: url(images/edit.png); width: 40px; height: 40px; border-radius: 10px; margin: 0px 20px; margin-bottom: 20px;" id="texttoolbox_edit"><input type="checkbox" autocomplete="off" istool="edit"></label>',e+="</div>",e+='<div class="input-group colorpicker-component" id="texttoolbox_color">',e+='<span class="btn btn-default add-on" style="width: 40px; height: 40px; border-radius: 100px;border: 5px solid #F0F0F0; margin: 0 20px; margin-bottom: 20px;"></span>',e+="</div>",$(".texttoolbox","#rightLayoutContainer").html(e),$("#texttoolbox_color").colorpicker({format:"hex",color:t.getFill()}).on("changeColor",b)}function b(t){var e=y.getActiveObject()
